...
p7 = [Load (ImmValue 10) 2,Store 2 (DirAddr 3),Load (ImmValue 0) 2,Store 2 (DirAddr 4),Load (DirAddr 4) 2,Store 2 (DirAddr 1),Load (ImmValue 10) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Gt 2 3 4,Store 4 (DirAddr 1),Load (ImmValue 1) 2,Load (DirAddr 1) 7,Compute Sub 2 7 7,Branch 7 (Rel 10),Load (DirAddr 3) 2,Store 2 (DirAddr 1),Load (DirAddr 4) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 3),Jump (Rel (-20)),Load (DirAddr 3) 2,WriteInstr 2 (DirAddr 65536),EndProg]
p8 = [Load (ImmValue 10) 2,Store 2 (DirAddr 3),Load (ImmValue 0) 2,Store 2 (DirAddr 4),Load (DirAddr 4) 2,Store 2 (DirAddr 1),Load (ImmValue 10) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Lt 2 3 4,Store 4 (DirAddr 1),Load (ImmValue 1) 2,Load (DirAddr 1) 7,Compute Sub 2 7 7,Branch 7 (Rel 10),Load (DirAddr 3) 2,Store 2 (DirAddr 1),Load (DirAddr 4) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 3),Jump (Rel (-20)),Load (DirAddr 3) 2,WriteInstr 2 (DirAddr 65536),EndProg]
p9 = [Load (ImmValue 10) 2,Store 2 (DirAddr 3),Load (ImmValue 0) 2,Store 2 (DirAddr 4),Load (DirAddr 4) 2,Store 2 (DirAddr 1),Load (ImmValue 10) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Lt 2 3 4,Store 4 (DirAddr 1),Load (ImmValue 1) 2,Load (DirAddr 1) 7,Compute Sub 2 7 7,Branch 7 (Rel 18),Load (DirAddr 3) 2,Store 2 (DirAddr 1),Load (DirAddr 4) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 3),Load (DirAddr 4) 2,Store 2 (DirAddr 1),Load (ImmValue 1) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 4),Jump (Rel (-28)),Load (DirAddr 3) 2,WriteInstr 2 (DirAddr 65536),EndProg]
p10 = [Load (ImmValue 10) 2,Store 2 (DirAddr 7),Load (ImmValue 0) 2,Store 2 (DirAddr 8),Load (DirAddr 8) 2,Store 2 (DirAddr 1),Load (ImmValue 10) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Lt 2 3 4,Store 4 (DirAddr 1),Load (ImmValue 1) 2,Load (DirAddr 1) 7,Compute Sub 2 7 7,Branch 7 (Rel 18),Load (DirAddr 7) 2,Store 2 (DirAddr 1),Load (DirAddr 8) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 7),Load (DirAddr 8) 2,Store 2 (DirAddr 1),Load (ImmValue 1) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 8),Jump (Rel (-28)),EndProg]
p11 = [Load (ImmValue 100) 2,Store 2 (DirAddr 7),Load (ImmValue 0) 2,Store 2 (DirAddr 8),Load (DirAddr 8) 2,Store 2 (DirAddr 1),Load (ImmValue 10) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Lt 2 3 4,Store 4 (DirAddr 1),Load (ImmValue 1) 2,Load (DirAddr 1) 7,Compute Sub 2 7 7,Branch 7 (Rel 18),Load (DirAddr 7) 2,Store 2 (DirAddr 1),Load (DirAddr 8) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 7),Load (DirAddr 8) 2,Store 2 (DirAddr 1),Load (ImmValue 1) 2,Store 2 (DirAddr 2),Load (DirAddr 1) 2,Load (DirAddr 2) 3,Compute Add 2 3 4,Store 4 (DirAddr 8),Jump (Rel (-28)),Load (DirAddr 7) 2,WriteInstr 2 (DirAddr 65536),EndProg]

p12 = [[Load (ImmValue 1) 2
       ,Store 2 (DirAddr 4)
       ,Load (ImmValue 2) 2
       ,Store 2 (DirAddr 4)
       ,Load (ImmValue 3) 2
